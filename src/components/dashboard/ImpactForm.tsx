  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="impact-description" className="text-sm text-zinc-400">
        ...
        <input
          ...
          disabled={isLoading}
          className="bg-zinc-900 border border-zinc-800 rounded-lg px-4 py-2.5 text-sm text-white placeholder-zinc-500 outline-none focus:border-zinc-600 focus:ring-2 focus:ring-zinc-500 disabled:opacity-50"
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col gap-1.5">
          <label htmlFor="impact-module" className="text-sm text-zinc-400">
            Module
          </label>
          <select
            id="impact-module"
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="impact-hours" className="text-sm text-zinc-400">
            Hours Saved
          </label>
          <input
            id="impact-hours"
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="self-start px-5 py-2.5 bg-white text-black text-sm font-medium rounded-lg hover:bg-zinc-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-500"
      >
